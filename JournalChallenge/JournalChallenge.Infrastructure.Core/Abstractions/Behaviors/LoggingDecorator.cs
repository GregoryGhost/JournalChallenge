...
internal static class LoggingDecorator
{
    ...
    {
        public async Task<Result<TResponse, IError<DomainError>>> HandleAsync(TCommand command, CancellationToken cancellationToken)
        {
    ...
    {
        public async Task<Result<TResponse, IError<DomainError>>> HandleAsync(TQuery query, CancellationToken cancellationToken)
        {
